...
// import FeaturedServicesForm from "../../DynamicPages/FeaturedServices";
...
//       styles={{
//         root: {
//           minHeight: "100%", // allow natural expansion
//           height: "auto", // disable fixed viewport
//         },
//         main: {
//           height: "auto",
//           minHeight: "auto",
...
//               {
//                 key: "bundle",
//                 to: "/admin-dashboard/package-bundle",
...
//               {
//                 key: "menu-bundle",
//                 to: "/admin-dashboard/menu-bundle-management",
//                 label: "Menu Bundles",
//               },
//               {
//                 key: "featured",
...
//       <AppShell.Main
//         className="!border-t-2 !border-gray-300 !bg-[#EFF6FF] !rounded-xl overflow-y-auto"
//         style={{
//           height: "100%", // ensure it fills the remaining height
//           minHeight: "calc(100vh - 60px)", // 60px header height
//         }}
//       >
//         <Routes>
...
import CalendarAvailability from "./CalendarAvailability";
import CalendarTUI from "../../pages/CalendarTUI";
import { IconLogout, IconUpload, IconPhoto, IconX } from "@tabler/icons-react";
import { logout } from "../../ItemsAxios";
import { notifications } from "@mantine/notifications";
import GeneralSetting from "../../pages/GeneralSetting";
import UserRoleManager from "../../pages/UserRoleManager";
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      >
        <AppShell.Header>
          <div className="h-full flex items-center justify-around px-10">
            ...
            <div
              ...
              className="font-semibold"
            >
              <button onClick={() => navigate("/")}>Silvestre</button>
            </div>
            <div className="flex justify-end gap-2">
              <p>Welcome back, {userData?.firstname}</p>
              <Tooltip label="logout">
        ...
        <AppShell.Navbar className="text-start pl-6 pr-6 py-12 border-none flex flex-col justify-between bg-white">
          <div className="flex flex-col">
            {/* Normal NavLinks */}
            {/* <NavLink
              className={`admin-btn ${
        ...
        <AppShell.Main
          className="!border-t-2 !border-gray-300 !bg-[#EFF6FF] !rounded-xl"
          style={{
        ...
        >
          <Routes>
            ...
            <Route path="reports" element={<Reports />} />
            <Route
              path="packagesAndServices"
              element={<PackagesAndServices />}
            />
            <Route path="/general-setting" element={<GeneralSetting />} />
            <Route path="/user-role-setting" element={<UserRoleManager />} />
            <Route path="package-bundle" element={<PackageBundle />} />
          ...
          <div className={`${photo ? "block" : "hidden"} py-4 px-4`}>
            <div className="flex items-end gap-1">
              {[32, 64, 128].map((size) => (
                <div
                  key={size}
                  className="inline-block rounded-full ring-4 ring-indigo-300 p-1"
                >
                  <Avatar
                    src={photo}
                    size={size}
                    className="rounded-full ring-4 ring-white"
                  />
                  <span className="ml-1">{size}px</span>
                </div>
              ))}
            </div>
          </div>
